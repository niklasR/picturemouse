 ...
 */
public class FEDistributeNewsletter extends javax.swing.JFrame {
    
    /**
     * Backend action Object
     */
    picturemouse.backend.BEDistributeNewsletter action = new picturemouse.backend.BEDistributeNewsletter();

    /**
     * Creates new form SignOn
     */
    public FEDistributeNewsletter() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FEDistributeNewsletter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FEDistributeNewsletter().setVisible(true);
            }
        });
    }
