 ...
 * @author John
 */
public class FEAdministratorOptions extends javax.swing.JFrame {
    BEDatabase d1 = BEDatabase.getInstance();
    /**
     * Creates new form AdministratorOptions
     */
    public FEAdministratorOptions() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FEAdministratorOptions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
