 ...
 * @author Jake Carr
 */
public class BEScreening implements Serializable
{
    /**
     ...
     */
    public BEScreening(int screeningId, Time time, Date date, int filmId, HashMap<Integer, String> seatingPlan){
    ...
    /**
     * Modifies the two fields input for a screening.
     * @param time
     * @param date 
     */
    public void modify(Time time, Date date)
    {
        this.time = time;
        this.date = date;
    }
