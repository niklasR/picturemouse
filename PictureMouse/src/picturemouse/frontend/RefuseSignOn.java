...
public class RefuseSignOn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(421, 252));
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RefuseSignOn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
