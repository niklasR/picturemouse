 ...
 */
public class FEBrowseTickets extends javax.swing.JFrame {
    ...
    picturemouse.backend.BEAccount account = database.lookupAccount(FESignOn.username, false);
    
    ArrayList<picturemouse.backend.BECinemaTicket> tickets = account.getTicketsPurchased();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FEBrowseTickets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
