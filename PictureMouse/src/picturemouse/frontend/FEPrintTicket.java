...
public class FEPrintTicket extends javax.swing.JFrame {
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        // TODO add your handling code here:
        String toPrint = "";
        picturemouse.backend.BEPrintTicket action = new picturemouse.backend.BEPrintTicket(toPrint);
        
        action.doIt(FEBrowseTickets.seat, FEBrowseTickets.screeningId, FEBrowseTickets.filmId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FEPrintTicket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
