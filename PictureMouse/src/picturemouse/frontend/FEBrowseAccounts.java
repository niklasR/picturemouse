 ...
 */
public class FEBrowseAccounts extends javax.swing.JFrame {

    
    ArrayList<picturemouse.backend.BEAccount> accounts = new ArrayList<>();
    
    /**
     * Creates new form BrowseAccounts
     */
    public FEBrowseAccounts() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblBrowseFilms.setText("Please select an account.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FEBrowseAccounts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
