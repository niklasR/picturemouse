 ...
 * @author jakecarr
 */
public class BEAccount implements Serializable
{
    private String username;
    private String password;
    private Boolean isAdmin;
    private ArrayList<BECinemaTicket> ticketsPurchased;
    ...
    public BEAccount(String username, String password, Boolean isAdmin, ArrayList<BECinemaTicket> ticketsPurchased, String firstName, long creditCardNo) 
    {
     ...
     */
    public void modify(String username, String password, Boolean isAdmin, ArrayList<BECinemaTicket> ticketsPurchased, String firstName, long creditCardNo)
    {
        this.username = username;
        this.password = password;
        this.isAdmin = isAdmin;
     ...
     */
    public ArrayList<BECinemaTicket> getTicketsPurchased() {
     ...
     */
    public void addTicket(BECinemaTicket ticket) {
